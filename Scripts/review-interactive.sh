...
screen="${2:-collection}"
case "$screen" in collection|motion|motion-flight|motion-biped|lifecycle|onboarding|graduation|compact-hatch-error|compact-placement-error) ;; *) echo "Unsupported review screen: $screen" >&2; exit 1 ;; esac
