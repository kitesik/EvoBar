...
for locale in "$@"; do
    ...
    for screen in home-incubator collection-incubator hatch-discovery home-egg-warming home-egg-held hatch-reduced-motion evolution-reduced-motion compact-ready-long-name compact-first-long-name; do
