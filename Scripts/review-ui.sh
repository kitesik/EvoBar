...
for locale in "$@"; do
    ...
    for screen in home-incubator collection-incubator hatch-discovery home-egg-warming home-egg-held hatch-reduced-motion evolution-reduced-motion compact-ready-long-name compact-first-long-name home-details-expanded switch-failed-detail switch-failed-collection hatch-failed-home hatch-failed-full-home hatch-failed-prompt; do
