...
for locale in "$@"; do
    ...
    for screen in shop-expanded settings-tracking-expanded hatch-field-note companion-card-graduated collection-ownership collection-owned-unhatched-detail; do
