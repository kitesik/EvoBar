...
Final evolution celebration (2026-09-24): only the final-stage reveal now centers a larger front portrait with a restrained glow and ring; intermediate evolutions retain their before/after comparison. Reduce Motion shows a static result without the white flash. This is a presentation change, not new art or growth rules. The remaining final-action mismatch is separate: the final form is already persisted on evolution, but the Home "Keep in Collection" control opens next-companion selection rather than performing a save. The owner deferred feedback on that next-companion flow; do not claim the control has been fixed or retire the current companion merely to make its label true.
