...
Coin pacing (2026-09-24): new usage days have a three-base-coin work cap; existing days and balances keep their old awards. Daily gifts and rare bonuses remain additional. The Shop coin badge explains the rule on hover and to assistive technology. Synthetic charged-egg walkthroughs show the first purchase around the third active day for several light-to-heavy profiles; very cache-heavy or very light use takes longer. This is a provisional gameplay choice, not a measured retention result. See [[GAMEPLAY_PACING]].
