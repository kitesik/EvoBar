...
Next product milestones: supported quota adapters if providers publish suitable APIs, localization, additional providers, production art, real purchase adapter, and notarized/Homebrew distribution.
