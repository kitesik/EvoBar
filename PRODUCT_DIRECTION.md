...
- Art resource replacement now covers all102 retained variants, including Pterosaur8, with full local regression and installation evidence in DEVELOPMENT_HANDOFF. Resource completion is not physical-animation acceptance. App Store remains on hold; payments/business registration are excluded from current work.

## Companion critique — 2026-09-23 follow-up

- **Growth:** full-line comparison exposed long waits, not just a slow first evolution. The revised ladder now finishes seven/eight-stage lines at2200/3200 XP, preserving early milestones and stored history. At500k daily tokens, seven-stage base completion changes140→44 active days and the longest interval60→16. See GAMEPLAY_PACING for actual-bonus simulations, assumptions and heavy/light-use limits. These are controlled calculations, not proof of enjoyment or a universal ETA.
...
- **Visual quality:**102/102 V2 variants is resource coverage, not proof of appealing motion. Pterosaur8 is now installed; inspect real small-scale animation before claiming full visual acceptance.
